...
public class SingleOrderDataModel implements Serializable {
    ...
    public class OrderModel implements Serializable
    {
        ...
        private OrderDataModel.Client client;
        private OrderDataModel.Provider provider;
        private OrderDataModel.Service service_titles;
        ...
        public OrderDataModel.Client getClient() {
            return client;
        }

        public OrderDataModel.Provider getProvider() {
            return provider;
        }
