package com.day.star.apps.homecare.ui_general_method;
...
public class UI_General_Method {
    ...
    public static void avatarUserNotification(View view,String endPoint)
    {
        ...
        if (endPoint!=null)
        {
            ...
            Picasso.with(roundedImageView.getContext()).load(Uri.parse(Tags.IMAGE_AVATAR+endPoint)).placeholder(R.drawable.splash).fit().into(roundedImageView);
        }else
        {
