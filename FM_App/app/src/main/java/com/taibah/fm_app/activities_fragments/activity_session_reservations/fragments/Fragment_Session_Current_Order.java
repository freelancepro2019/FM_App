...
public class Fragment_Session_Current_Order extends Fragment {
    ...
    public static Fragment_Session_Current_Order newInstance() {

        return new Fragment_Session_Current_Order();
    }
