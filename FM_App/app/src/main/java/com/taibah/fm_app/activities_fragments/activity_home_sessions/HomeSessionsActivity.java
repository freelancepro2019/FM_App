...
public class HomeSessionsActivity extends AppCompatActivity implements Listeners.BackListener, OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, LocationListener, Listeners.HomeSessionListener, DatePickerDialog.OnDateSetListener, TimePickerDialog.OnTimeSetListener {
    ...
    private void addService() {
        ...
        HomeSessionModel.Service service2 = new HomeSessionModel.Service(1, "تدليك", "100");
        HomeSessionModel.Service service3 = new HomeSessionModel.Service(2, "تدريب منزلى", "200");
        HomeSessionModel.Service service4 = new HomeSessionModel.Service(3, "بوكسينج", "300");
        HomeSessionModel.Service service5 = new HomeSessionModel.Service(4, "لياقة بدنية", "400");
        HomeSessionModel.Service service6 = new HomeSessionModel.Service(5, "زيادة وزن", "500");
